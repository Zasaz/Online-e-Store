...
$sql="SELECT * FROM post WHERE category='Utilities'";
...
$sql="SELECT * FROM post  WHERE category='Utilities' LIMIT " . $this_page_first_result . ',' .  $results_per_page;
$result = mysqli_query($database, $sql);
...
for ($page=1;$page<=$number_of_pages;$page++) {?>
  ...
  <ul class="pagination pagination-lg ">
    ...
    <li class="page-item" align="center" ><?php echo '<a  class="page-link" href="categoryutillities.php?page=' . $page . '">' . $page . '</a> '; ?> </li>
